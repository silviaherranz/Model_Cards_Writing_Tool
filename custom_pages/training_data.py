...
import utils
from render import FieldProps, render_field, render_image_field, should_render
...
def _render_fine_tuned_from(section: TrainingData) -> None:
    utils.title_header(TITLE_FINE_TUNED)
    utils.light_header_italics(FINE_TUNED_INFO)
...
def _render_navigation() -> None:
    ...
    with col1:
        if st.button("Previous"):
            from custom_pages.technical_specifications import (  # noqa: PLC0415
